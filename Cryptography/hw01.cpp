...
#include <unistd.h>
#include <fcntl.h>
//#include <sys/wait.h> //not needed
#include <sys/types.h>
#include <sys/stat.h>
//#include <sysexits.h> //not needed
#include <unistd.h>
#include <errno.h>
#include <inttypes.h>
#include <vector>
...
//defines: wanting to expand my knowledge base here a bit
...
int main() {
	...
	std::cout << std::endl;
	while((num < 4 && num >= 0)) { //loop for testing functions
